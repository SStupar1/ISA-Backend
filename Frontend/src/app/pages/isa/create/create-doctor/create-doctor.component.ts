...
export class CreateDoctorComponent implements OnInit {
  ...
  private user: any;
  public listOfData = [];
  startWorkAt: Date | null = null;
  endWorkAt: Date | null = null;
  appointmentTypeId = null;

  constructor(private appointmentService: AppointmentService, private fb: FormBuilder, private adminService: AdminService, private router: Router, private route: ActivatedRoute) {}
  ...
  submitForm(): void {
...

    {
      const body = {
        ...
        startWorkAt: moment(this.startWorkAt).format("HH:mm:ss"), 
        endWorkAt: moment(this.endWorkAt).format("HH:mm:ss"),
        appointmentTypeId: this.appointmentTypeId,
        clinicId: this.user.myClinic.id
      }
      console.log(body)
      this.adminService.createDoctor(body, this.user.myClinic.id).subscribe(data => {
